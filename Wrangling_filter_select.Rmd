...
There are 1,248 movies released in 1995
...
This chart shows us that the movies that are in here are Harry Potter and the sorcerers stone, the chamber of secrest, and the prisoner of azkaban. Harry Potter and the prisoner of Azkaban is the highest rated. Harry Potter and the Socerers Stone is the Harry Potter movie with the most votes. 
...
arrange(desc(budget))
print (movies_2000$budget)    
```

In this chart we can see the highest budget was $170000000.

The highest budget for a comedy or animation movie 
